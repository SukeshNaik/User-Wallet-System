...
public interface WalletService {
	    ...
	    /**
	     * Create a new wallet for a user - I assume user is already in the system (in my case User table, in H2 database)
	     * @param customerId : User which has requested creation of new wallet
	     * @return : A newly created wallet object
	     * @throws CustomerDoesNotExistException - if customer does not exist in the User table
